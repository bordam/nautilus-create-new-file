...
1. Run in the terminal:
   ```bash
	...
	curl -L -o ~/.local/share/nautilus-python/extensions/nautilus-create-new-file.py https://raw.githubusercontent.com/not_simboi/nautilus-create-new-file/main/nautilus-create-new-file.py
	# 3. restart nautilus
	nautilus -q
	```
2. Profit
